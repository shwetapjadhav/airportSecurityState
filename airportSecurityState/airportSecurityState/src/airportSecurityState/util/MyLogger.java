...
public class MyLogger {
    ...
    DEBUG_VALUE=2 [Print to stdout everytime a new action is added to Results data structure]
    DEBUG_VALUE=1 [Print to stdout everytime the action contents from data structure array store]
